...
class MetersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create meter" do
    assert_difference('Meter.count') do
      post meters_url, params: { meter: { end_date: @meter.end_date, readings: @meter.readings, start_date: @meter.start_date } }
    end
  ...
  test "should update meter" do
    patch meter_url(@meter), params: { meter: { end_date: @meter.end_date, readings: @meter.readings, start_date: @meter.start_date } }
